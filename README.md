...
Test your existing infrastructure than write correct detection & response rules. Send detected event logs SIEM and SOAR systems than
hunt threats if any APT organization want to steal your data. 
